...
project = pyswrd.__name__
author = re.match("(.*) <.*>", pyswrd.__author__).group(1)
year = datetime.date.today().year
copyright = "{}, {}".format("2024" if year == 2024 else "2024-{}".format(year), author)

# extract the semantic version
semver = semantic_version.Version.coerce(pyswrd.__version__)
...
doc_lines = pyswrd.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyswrd",
    ...
    "switcher": {
        "json_url": "https://pyswrd.readthedocs.io/en/latest/_static/switcher.json",
...
intersphinx_mapping = {
    ...
    "pyopal": ("https://pyopal.readthedocs.io/en/stable/", None),
